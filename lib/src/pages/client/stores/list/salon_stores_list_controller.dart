...
import 'package:maslindapp/src/pages/client/appointment/detail/client_appointment_detail_page.dart';
import 'package:maslindapp/src/pages/client/stores/detail/client_stores_detail_page.dart';
...
void openBottonSheet(Stores stores) {
  showMaterialModalBottomSheet(
      context: context,
      builder: (context) => ClientStoresDetailPage(stores: stores)
  );
}
...
void goToCreateStores() {
  Navigator.pushNamed(context, 'client/stores/create');
}
